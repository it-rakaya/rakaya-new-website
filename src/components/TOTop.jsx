        ...
        <div className="position-fixed bottom-0 mb-3 z-index-high" style={{ left: "16px" }}>
          ...
          >
            ...
            {/* <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path opacity="0.5" fillRule="evenodd" clipRule="evenodd" d="M12 20.75C12.4142 20.75 12.75 20.4142 12.75 20L12.75 10.75L11.25 10.75L11.25 20C11.25 20.4142 11.5858 20.75 12 20.75Z" fill="currentColor"></path>
            ...
            <i style={{fontSize:"1.7rem"}} class="bi bi-caret-up"></i>
            </div>
          </button>
        </div>
      )}
