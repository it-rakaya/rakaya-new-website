  ...
  return (
    <>
      ...
      <VisionLayout title="أسس">
        <Container className="col-9 d-flex flex-wrap justify-content-center justify-content-lg-start mx-0 gap-3">
          ...
          <ul className="mx-5">
            <li>اسأل المتقدمين للوظيفة في ركايا عن روتينهم اليومي واستفسر عما حققوه في الشهر الماضي. تأكد من الحصول على إجابات مفصلة ودقيقة. من المهم أن تفهم كيف توصلوا إلى حلول للتحديات التي واجهوها، أو كيف ساهموا في نجاح المشاريع التي عملوا عليها، حيث يمكن أن يكون من السهل نسب نجاح المشاريع إلى أنفسهم.</li>
            <li>اختبر قدراته في مهمة عملية قبل أن تتخذ قرار التوظيف.</li>
            <li>أن تقتصر على توظيف الأفراد الاستثنائيين في ركايا لا يضمن النجاح بنسبة 100%، ولكن إذا شعرت بالراحة تجاه المرشح، فدع حدسك يكون مرشدك.</li>
            <li>
              تحلّى بالجرأة لاتخاذ المخاطرات في ركايا؛ هذا أمر جيد. ومع ذلك، لا تتنازل أبدًا عن توظيف شخص غير مؤهل. إذا لزم الأمر، لا تتردد في إنهاء التعاقد مع الأشخاص الذين لا يؤدون بشكل جيد. الموظفون الأكفاء سيجذبون مزيدًا من الكفاءات، بينما الأشخاص ذوي الأداء الضعيف قد يؤدون إلى تدهور أداء الشركة.
            </li>
          </ul>
